...
添加 from functools import reduce 

3. 解决python3 无法直接使用cv_bridge
重新编译cv_bridge  参考https://cyaninfinite.com/ros-cv-bridge-with-python-3/#Dependencies
